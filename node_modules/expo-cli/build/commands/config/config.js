...
function _default(program) {
  program.command('config [path]').description('Show the project config').helpGroup('info').option('-t, --type <type>', 'Type of config to show. Options: public, prebuild, introspect').option('--full', 'Include all project config data').asyncActionProjectDir((0, _profileMethod().profileMethod)(actionAsync));
}
