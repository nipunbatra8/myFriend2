...
function getHermesCommand(projectRoot) {
    ...
    const resolvedPath = resolve_from_1.default.silent(projectRoot, `hermes-engine/${platform}/hermesc`);
    if (!resolvedPath) {
        throw new Error(`Missing module "hermes-engine/${platform}/hermesc" in the project.` +
