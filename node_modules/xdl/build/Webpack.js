...
async function getAvailablePortAsync(options) {
  try {
    ...
    const port = await (0, _internal().choosePortAsync)(options.projectRoot, defaultPort, 'host' in options && options.host ? options.host : _internal().WebpackEnvironment.HOST);
