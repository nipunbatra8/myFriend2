...
async function startDevServerAsync(projectRoot, startOptions) {
  ...
  if (startOptions.metroPort != null) {
    ...
    port = startOptions.devClient ? Number(process.env.RCT_METRO_PORT) || 8081 : await (0, _internal().getFreePortAsync)(19000);
  }
  ...
  middleware.use(_internal().ManifestHandler.getManifestHandler(projectRoot)); // We need the manifest handler to be the first middleware to run so our
