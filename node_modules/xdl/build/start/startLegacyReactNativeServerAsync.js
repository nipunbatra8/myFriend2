...
async function startReactNativeServerAsync({
  ...
  let packagerPort = (_options$metroPort = options.metroPort) !== null && _options$metroPort !== void 0 ? _options$metroPort : await (0, _internal().getFreePortAsync)(19001); // Create packager options
